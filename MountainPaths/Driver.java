...
public class Driver
{
    ...
    public static void main(String[] args){
        ...
        g.setColor(Color.YELLOW); //set brush to green for drawing best path
        map.downHillPath(g, bestRow);
        System.out.println("The Down hill path is in yellow");
        
        g.setColor(Color.BLUE);
        map.lowestElevInCol(g);
        System.out.println("Blue Spots represent the lowest elevations in each column of the grid");
        
        System.out.println("Pink path represents west to east path from arbitrary (x,y) location");
        System.out.println("White path represents east to west path from arbitrary (x,y) location");
        map.drawXY(g);
