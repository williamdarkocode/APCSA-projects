 ...
 *  {@code Color} data type that is discussed in Chapter 3. Until then,
 ...
 *  </ul>
 *  <p>
 *  You use the {@code Font} data type to specify the font. This allows you to
 ...
 *  <li> Except as noted in the APIs, all methods accept {@code Double.NaN},
 *       {@code Double.POSITIVE_INFINITY}, and {@code Double.NEGATIVE_INFINITY}
...
*/
    ...
    *  as an argument. It can handle action keys
     ...
     * See {@code KeyEvent} for a description of key codes.
     *
